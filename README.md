...
│
├── app/
│   ├── main.py                 # FastAPI entry point + channel webhooks
│   │
│   ├── bot/                    # Telegram bot
...
│   │
│   ├── channels/               # Channel adapters and ingress routes
│   │   ├── routes.py           # /api/channels/* webhooks
│   │   └── *.py                # Telegram/Slack/Discord/Web adapters
│   │
...
2. Open the frontend app and complete Google authorization flow
